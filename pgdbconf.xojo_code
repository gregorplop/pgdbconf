...
Protected Module pgdbconf
	...
	#tag Method, Flags = &h0
		Function pgdbconf_createTable(extends db as PostgreSQLDatabase, tablename as string) As string
		  ...
		  dim INSERTINITRECORD as String = "INSERT INTO " + tablename + " (section , key , value , comment) VALUES ('PGDBCONF' , 'INITSTAMP' , '" + date(new date).SQLDateTime + "' , 'Automatically generated by pgdbconf')"
	...
	#tag Method, Flags = &h0
		Function pgdbconf_getDefaultLanguage() As string
	...
	#tag Method, Flags = &h0
		Function pgdbconf_getGlobalName() As string
		  Return GlobalName
